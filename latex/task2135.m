...
Species = [  0.25        0           0.45    3.46     0.2325      0          50     38      0.4828            60            191           4;  %亮绿
             0.49        0           0.19    4.34     0      0          50     113      0.7852             176            191           4; %浅绿
             1.07        0           0.11    1.43     0        0          50     188      0.0345            211            135           12; %粽
             4.71        0           0.1     1.29     0.2847      0          50     263      0              255            231           94; %黄
            
             1.96        0           0.09    1.28     0.5695      0          150     38      0                73            177           251; %浅蓝
             6.38        0           0.13    1.68     0.5695      0          150     113      0.09549            251            82           73; %红
             10.62       0           0.12    1.31     0.7884      0          80     88      0               255            162           198; %粉
             10.8        0           0.27    2.81     0.9864      0          210     163      0.3581              44            104           255; %深蓝
             
             1.54        0           0.42    1.99     0.4932      0          250     38      0.1008               180            136           253; %紫
             8.75        0           0.1     1.29     1           0          250     113      0               200            200           200; %灰
             3.88        0           0.08    1.27     0.8054      0          250     188      0              100            100           100;  %深灰
             0.77        0           0.29    5.25     0.4931      0          150     263      1              26            80          1 ]; %深绿
                                    %0.1958  2.283   
         % low     max
...
hold on;
for q = 1:numberSpecies
    plot(1/30:1/30:length(SquareNumber)/30,SquareNumber(q,:),'LineWidth',2,'Color',[Species(q,10)/256,Species(q,11)/256,Species(q,12)/256]);
end
legend('F1','F2','F3','F4','F5','F6','F7','F8','F9','F10','F11','F12','Location','northwest');
